...
export default function Docs() {
  const levelProgression = [
    { level: 1, xp: getXpForLevel(1), equivalent: "Começando", days: "0" },
    {
      level: 2,
      xp: getXpForLevel(2),
      equivalent: "Primeiros commits",
      days: "1",
    },
    {
      level: 3,
      xp: getXpForLevel(3),
      equivalent: "Contribuidor ativo",
      days: "2",
    },
    {
      level: 5,
      xp: getXpForLevel(5),
      equivalent: "Dev consistente",
      days: "4",
    },
    {
      level: 10,
      xp: getXpForLevel(10),
      equivalent: "Desenvolvedor experiente",
      days: "15",
    },
    {
      level: 15,
      xp: getXpForLevel(15),
      equivalent: "Senior developer",
      days: "34",
    },
    {
      level: 20,
      xp: getXpForLevel(20),
      equivalent: "Expert developer",
      days: "60",
    },
        ...
        <div className="space-y-5">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="p-4 bg-muted rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Contribuições significativas valem mais que spam de
                      commits.
                    </p>
                  </div>
                  <div className="p-4 bg-muted rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Sistema com caps diários e penalidades para prevenir
                      exploração.
                    </p>
                  </div>
                  <div className="p-4 bg-muted rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Incentiva diferentes tipos de atividades: commits, PRs,
                      reviews, etc.
                    </p>
                  </div>
                  <div className="p-4 bg-muted rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Sistema inspirado em Pokémon mantém engajamento a longo
                      prazo.
                    </p>
                  </div>
                </div>
          ...
          <Card className="bg-orange-500/10 border-orange-500/50">
            <CardContent className="space-y-6">
              ...
              <p className="text-muted-foreground">
                Cada classe tem multiplicadores únicos de XP baseados em seu
              ...
              <div className="bg-blue-500/20 border border-blue-500/50 rounded-lg p-4 mb-4">
                ...
                <ul className="text-xs text-muted-foreground space-y-1">
                  <li>
                    <strong>Commits</strong> - 10 XP base × multiplicador de
                    classe
                  </li>
                  <li>
                    <strong>Pull Requests (criados por você)</strong> - 25 XP
                    base × multiplicador de classe
                  </li>
                  <li>
                    <strong>Issues Resolvidas</strong> - 35 XP base ×
                    multiplicador de classe
                  </li>
                </ul>
                <p className="text-sm font-bold text-orange-400 mt-3 mb-2">
                  Em Desenvolvimento
                </p>
                <ul className="text-xs text-muted-foreground space-y-1">
                  <li>
                  ...
                  <li>
                    <strong>Large Commits (&gt;100 linhas)</strong> - Bônus
                    extra para commits grandes
                  </li>
                  <li>
                    <strong>Stars/Forks nos seus repos</strong> - Reconhecimento
                    da comunidade
                  </li>
                  <li>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        ...
                        <h4 className="text-sm font-bold text-orange-500 mt-4">
                          Em Desenvolvimento:
                        </h4>
              ...
              <div className="bg-background rounded-lg p-4 space-y-3">
                ...
                <ul className="text-xs text-muted-foreground space-y-1 list-disc list-inside">
                  ...
                  <li>
                    Escolha a classe que combina com seu estilo de
                    desenvolvimento!
                  </li>
                  <li>
                    <strong className="text-orange-500">XP Base Atual:</strong>{" "}
                    10 XP/commit, 25 XP/PR, 35 XP/issue
                  </li>
                </ul>
              </div>
            </CardContent>
                      ...
                      >
                        ...
                        <td className="py-3 px-4">
                          {idx < levelProgression.length - 1
                            ? (
                                levelProgression[idx + 1].xp - item.xp
                              ).toLocaleString()
                            : "-"}
                        </td>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Cada commit conta igualmente. Multiplicado pela classe do
                    personagem.
                  </p>
            ...
            <Card>
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Cada PR criado/aberto por você (não conta quem aprova ou faz
                    merge). Multiplicado pela classe do personagem.
                  </p>
                  <div className="pt-2 border-t border-border">
                    <p className="text-xs text-orange-400 font-bold mb-1">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="bg-green-500/20 border border-green-500/50 rounded-lg p-4">
                ...
                <ul className="text-xs text-muted-foreground space-y-2">
                  <li>
                    <strong>Primeira sincronização:</strong> Você recebe XP
                    pelas atividades dos últimos 7 dias
                  </li>
                  <li>
                    <strong>Histórico anterior:</strong> Tudo antes dos últimos
                    7 dias vira "baseline" (não gera XP)
                  </li>
                  <li>
                    <strong>Syncs seguintes:</strong> Apenas atividades NOVAS
                    após entrar na plataforma geram XP
                  </li>
                  <li>
                    <strong>Exemplo:</strong> Se você tem 500 commits totais e
                    10 nos últimos 7 dias, recebe XP pelos 10 commits. Os 490
                    anteriores viram baseline
                  </li>
                  <li>
                    <strong>Justo:</strong> Você começa com algum XP se foi
                    ativo recentemente, mas não se beneficia de todo o histórico
                  </li>
                </ul>
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="bg-blue-500/20 border border-blue-500/50 rounded-lg p-4">
                ...
                <ul className="text-xs text-muted-foreground space-y-2">
                  ...
                  <li>
                    <strong>Silencioso:</strong> Não interrompe seu fluxo de
                    trabalho
                  </li>
                  <li>
                    <strong>Eficiente:</strong> Só sincroniza se houver novas
                    atividades
                  </li>
                  <li>
                    <strong>Cooldown:</strong> Previne spam de requisições ao
                    GitHub
                  </li>
                </ul>
              </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-4">
                <div className="bg-muted/50 p-4 rounded-lg">
                  <h3 className="font-bold text-sm mb-2 text-orange-500">
                    Em Desenvolvimento
                  </h3>
                  <ul className="text-xs text-muted-foreground space-y-1">
                    <li>
                      <strong>Code Reviews:</strong> XP por revisar PRs de
                      outros devs
                    </li>
                    <li>
                      <strong>Large Commits:</strong> Bônus extra para commits
                      grandes (&gt;100 linhas)
                    </li>
                    <li>
                      <strong>Stars/Forks:</strong> Reconhecimento da comunidade
                      nos seus repos
                    </li>
                    <li>
                      <strong>Releases:</strong> XP por publicar versões de
                      projetos
                    </li>
                    <li>
                      <strong>Guilds:</strong> Sistema de grupos e competições
                      entre times
                    </li>
                    <li>
                      <strong>Achievements:</strong> Conquistas especiais e
                      badges
                    </li>
                  </ul>
                </div>
          ...
          <Card className="bg-orange-500/10 border-orange-500/50">
            <CardContent className="space-y-6">
              ...
              <p className="text-sm text-muted-foreground">
                Caps inteligentes por tipo de atividade previnem farming e
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="p-4 bg-background rounded-lg border border-orange-500/30">
                  ...
                  <p className="text-3xl font-black">
                    {XP_CONSTANTS.MAX_XP_PER_DAY} XP
                  </p>
                ...
                <div className="p-4 bg-background rounded-lg border border-border">
                  ...
                  <p className="text-2xl font-black">
                    {XP_CONSTANTS.MAX_COMMIT_XP_PER_DAY} XP/dia
                  </p>
                  <p className="text-xs text-muted-foreground mt-2">
                    40% do cap total
                  </p>
                ...
                <div className="p-4 bg-background rounded-lg border border-border">
                  ...
                  <p className="text-2xl font-black">
                    {XP_CONSTANTS.MAX_PR_XP_PER_DAY} XP/dia
                  </p>
                  <p className="text-xs text-muted-foreground mt-2">
                    30% do cap total
                  </p>
                ...
                <div className="p-4 bg-background rounded-lg border border-border">
                  ...
                  <p className="text-2xl font-black">
                    {XP_CONSTANTS.MAX_REVIEWS_XP_PER_DAY} XP/dia
                  </p>
                  <p className="text-xs text-muted-foreground mt-2">
                    20% do cap total
                  </p>
                ...
                <div className="p-4 bg-background rounded-lg border border-border">
                  <p className="font-bold mb-2">Issues resolvidas</p>
                  <p className="text-2xl font-black">
                    {XP_CONSTANTS.MAX_ISSUES_XP_PER_DAY} XP/dia
                  </p>
                  <p className="text-xs text-muted-foreground mt-2">
                    20% do cap total
                  </p>
                ...
                <div className="p-4 bg-background rounded-lg border border-border">
                  ...
                  <p className="text-2xl font-black">
                    {XP_CONSTANTS.MAX_STARS_XP_PER_DAY} XP/dia
                  </p>
                  <p className="text-xs text-muted-foreground mt-2">
                    10% do cap total
                  </p>
          ...
          <Card>
            <CardContent className="space-y-4">
              ...
              <div className="bg-orange-500/20 border border-orange-500/50 rounded-lg p-4">
                ...
                <p className="text-xs text-muted-foreground">
                  A fórmula foi simplificada drasticamente. Agora é{" "}
                  <strong>Level² × 15</strong> ao invés de Level² × 100 + Level
                  × 50. Isso permite alcançar Level 10 em apenas 15 dias de
                  atividade consistente (~10 commits/dia ou 2 PRs/dia).
                </p>
              </div>
              <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground italic">
                Exemplo: Commit externo com bônus de classe usa o MAIOR entre
                1.5x (externo) ou 1.3x (classe), não 1.95x (1.5 × 1.3).
              </p>
            </CardContent>
          </Card>
          ...
          <div className="text-xs text-center text-muted-foreground space-y-2">
            <p>
              As atividades do GitHub são sincronizadas automaticamente quando
              você acessa o leaderboard.
            </p>
            <p>
              Cooldown de 5 minutos entre syncs. Sistema anti-duplicação e caps
              inteligentes ativos.
            </p>
          </div>
        </div>
